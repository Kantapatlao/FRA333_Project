...
**การทำงาน**
  ...
  - เมื่อโปรแกรมเริ่มต้นขึ้น จะมีการโหลดแผนที่จากไฟล์ map(1-5).npy เลือกแผนที่ได้โดยการเปลี่ยนเลข
  - หุ่นยนต์จะใช้ A Algorithm* ในการคำนวณเส้นทางจากตำแหน่งเริ่มต้นไปยังจุดหมายที่กำหนด
  - ผู้ใช้สามารถกดปุ่มลูกศรซ้าย (←) และลูกศรขวา (→) เพื่อเปลี่ยนสถานะ (state) และดูการเคลื่อนที่ของหุ่นยนต์
  - โปรแกรมจะมีการแสดงแผนที่และหุ่นยนต์บนหน้าจอ
